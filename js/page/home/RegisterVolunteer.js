            ...
            <View style={{backgroundColor:'white'}}>
                <ScrollView>
                    <View style={styles.container}>
                        ...
                        <Text style={styles.titleStyle}>注册志愿者</Text>
                    ...
                    <View style={{flexDirection:'row' ,justifyContent:'space-between',  borderBottomWidth:1,  borderColor:'#B3A0A7' }}>
                        ...
                        <TextInput style={{ height:Platform.OS=="ios"?30:40,width:Platform.OS=="ios"?170:180,
                                            alignItems:'center',marginTop:2,fontSize:14,color:'#B3A0A7',paddingLeft:12}}
                                   placeholder='请输入手机号码'
                                   underlineColorAndroid='transparent'
                                   multiline={true}
                                   onChangeText={(text)=>this.setState({RepassWord:text})}
                        />
                        <TouchableOpacity style={{alignItems:'center',margin:2}} onPress={()=>{this.handleTimeClick()}}>
                            <Text style={{padding:8,borderColor:'#00b3b3',borderRadius:4,borderWidth:2}}>{text}</Text>
                        </TouchableOpacity>
                    </View>

                    <View style={styles.detailItemStyle}>
                        <Text style={styles.detailLeftTextStyle}>验证码:</Text>
                        <TextInput style={[styles.detailInputTextStyle,{marginLeft: 28}]}
                                   placeholder='请输入验证码'
                                   underlineColorAndroid='transparent'
                                   multiline={true}
                                   onChangeText={(text)=>this.setState({RepassWord:text})}
